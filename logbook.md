...
**12:30-15:30** While writing the discussion and running the evaluations of dataset 2, I downloaded, converted, labeled, and preprocessed the GTZAN dataset (234MB to 2.32GB, 1000 samples, 10 classes). I let the DAS-4 evaluate it using the two models, just in case there's time to add it to the report.
