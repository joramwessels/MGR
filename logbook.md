...
**12:30-15:30** While writing the discussion and running the evaluations of dataset 2, I downloaded, converted, labeled, and preprocessed the GTZAN dataset (234MB to 2.32GB, 1000 samples, 10 classes). Sadly, the DAS couldn't run it, but my desktop caould, and it got a .142 accuracy (0R=.1). I also noticed that only the DAS errors on every first session, not my desktop. I finished 10 rounds of optimization for all tasks on dataset 2 and put them in the report.  
**18:30-23:00** I concluded all testing an drew my conclusions: subgenre targeting is not a breakthrough, but might have some potential. I wrote the conclusion, finished the experiment paragraphs, added to the discussion, and wrote the abstract. I still have to read the whole thing through. What I can already tell that still needs improvement is the layout (front page picture), the preprocessing (MFCC explanation and picture), the related work (a little adjustment to fit the new narrative without the CRNN), and maybe something extra here and there in the approach.  
